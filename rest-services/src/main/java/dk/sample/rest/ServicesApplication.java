...
import dk.sample.rest.bank.location.exposure.rs.LocationEventFeedMetadataServiceExposure;
import dk.sample.rest.bank.location.exposure.rs.LocationEventServiceExposure;
...
public class ServicesApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.addAll(Arrays.asList(
                        ...
                        LocationServiceExposure.class,
                        LocationEventServiceExposure.class,
                        LocationEventFeedMetadataServiceExposure.class)
        );
