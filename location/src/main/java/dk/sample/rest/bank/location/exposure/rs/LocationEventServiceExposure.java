...
import dk.sample.rest.bank.location.exposure.rs.model.EventRepresentation;
import dk.sample.rest.bank.location.exposure.rs.model.EventsRepresentation;
...
@Api(value = "/customer-events",
     tags = {"events"})
public class LocationEventServiceExposure {
    ...
    public LocationEventServiceExposure() {
