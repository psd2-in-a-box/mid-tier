...
public class CustomerEventServiceExposureTest {
    ...
    public void testListEvents() throws URISyntaxException {
        ...
        Response response = service.listAllCustomerEvents(ui, request, "application/hal+json", "");
        ...
        response = service.listAllCustomerEvents(ui, request, "application/hal+json;no-real-type", "");
    ...
    public void testGetEvent() throws URISyntaxException {
        ...
        Response response = service.getSingleCustomerEvents(ui, request, "application/hal+json", "new-card", "eventSID");
        ...
        response = service.getSingleCustomerEvents(ui, request, "application/hal+json;no-real-type", "5479-123456", "eventSID");
        assertEquals(415,response.getStatus());
